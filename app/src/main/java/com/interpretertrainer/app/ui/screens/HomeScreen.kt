...
fun HomeScreen(onNavigate: (String) -> Unit) {
    Scaffold { padding ->
        LazyColumn(
            ...
            item { TrainingCard("Interpreter Coach", "Chat with an offline interpreter assistant, review progress and evaluate performance.", Icons.Default.AutoAwesome) { onNavigate(Routes.AI_COACH) } }
